...
describe('Product Routes', () => {
    ...
    describe('UPDATE Product', () => {
        ...
        test('should update a product', async () => {
            ...
            expect(response.body.description)
                .toBe(updatePayload.description);
            expect(response.body.price)
                .toBe(parseFloat(updatePayload.price));
            expect(response.body.available)
                .toBe(updatePayload.available);
            expect(response.body.category)
                .toBe(updatePayload.category);
        });
    ...
    describe('LIST Products', () => {
        ...
        test('should filter products by category', async () => {
            ...
            await request(app)
                .post(BASE_URL)
                .send(defaultCategoryProduct)
                .expect(201);

            await request(app)
                .post(BASE_URL)
                .send(specialCategoryProduct)
                .expect(201);
        ...
        test('should filter products by availability', async () => {
            ...
            await request(app)
                .post(BASE_URL)
                .send(availableProduct)
                .expect(201);

            await request(app)
                .post(BASE_URL)
                .send(unavailableProduct)
                .expect(201);
